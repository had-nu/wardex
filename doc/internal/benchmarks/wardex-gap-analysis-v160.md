...
|---|---|:---:|:---:|---|
| G-01 | `--expires 30d` silently fails | [OK] | [OK] | `pkg/duration/duration.go` — `ParseExtended()` |
| G-02 | `--config` ignored by `accept` subcommands | [OK] | [OK] | `pkg/accept/cli/cli.go` — config pointer propagation |
| G-03 | Multi-CVE acceptance drops all but first | [OK] | [OK] | `pkg/accept/cli/cli_multicve_test.go` |
| G-04 | Exit code 2 on BLOCK (POSIX conflict) | [OK] | [OK] | `pkg/exitcodes/exitcodes.go` — `GateBlocked=10` |
| G-05 | Banned phrases equality match (not substring) | [OK] | [OK] | `pkg/accept/validator/validator.go` — `strings.Contains` |
| G-06 | No `--version` flag | [OK] | [OK] | `main.go` — `rootCmd.Version` with ldflags |
...
|---|---|:---:|:---:|---|
| **G-07** | `verify-forwarding` not implemented | [PARTIAL] PARTIAL | [OK] **RESOLVED** | Real TCP/HTTP probe — see below |
| G-08 | `accept list` output json/csv missing | [OK] | [OK] | No change needed |
| G-09 | `warn` decision never produced | [OK] | [OK] | No change needed |
| G-10 | Roadmap hard-capped at 10 items | [OK] | [OK] | No change needed |
| G-11 | Snapshot path not configurable | [OK] | [OK] | No change needed |
...
| ID | Title | v1.5.0 | v1.6.0 | Change |
|---|---|:---:|:---:|---|
| G-12 | No native Grype input adapter | [OK] | [OK] | No change needed |
| G-13 | No CycloneDX/SPDX SBOM ingestion | [OK] | [OK] | No change needed |
| G-14 | No `warn` threshold / risk band | [OK] | [OK] | No change needed |
| **G-15** | No RBAC / per-team risk appetite | [PARTIAL] PARTIAL | [OK] **RESOLVED** | `AllowedActors` enforcement — see below |
| G-16 | Risk simulator not shipped | [OK] | [OK] | No change needed |
| G-17 | No VEX support | [OK] | [OK] | No change needed |
| G-18 | No godoc API reference | [OK] | [OK] | No change needed |
...
| ID | Title | v1.5.0 | v1.6.0 | Change |
|---|---|:---:|:---:|---|
| G-19 | No SOC 2 / NIS2 / DORA mapping | [OK] | [OK] | No change needed |
| **G-20** | No external security audit | [PARTIAL] PARTIAL | [PARTIAL] **PARTIAL** | Improved posture, gap persists |
| **G-21** | AGPL-3.0 / no dual licensing | [OPEN] OPEN | [OK] **RESOLVED** | Full dual-licensing infrastructure shipped |
| G-22 | No changelog / release notes | [OK] | [OK] | No change needed |
...
|---|---|:---:|
| Commercial licence terms | `doc/COMMERCIAL_LICENSE.md` | [OK] Present |
| Contributor Licence Agreement | `doc/CLA.md` | [OK] Present |
| CLA GitHub Actions workflow | `.github/workflows/cla.yml` | [OK] Live |
| Copyright notice on LICENSE | `LICENSE` line 1 | [OK] Present |
| SPDX dual identifier on all sources | All `*.go` files | [OK] Present |
| README dual-licensing section | `README.md` — "Licenciamento e Uso Comercial" | [OK] Present |
| CONTRIBUTING.md CLA requirement | `CONTRIBUTING.md` | [OK] Present |
...
**Category:** [OPEN] Bug · **Priority:** Critical · **Effort:** XS · **Adoption Impact:** (ooooo) (5/5)
...
**Category:** [PARTIAL] Incomplete · **Priority:** High · **Effort:** M · **Adoption Impact:** (oooo) (4/5)
...
**Category:** [PARTIAL] Incomplete · **Priority:** Medium · **Effort:** S · **Adoption Impact:** (ooo) (3/5)
...
**Category:** [OPEN] Open · **Priority:** Medium · **Effort:** XS · **Adoption Impact:** (ooo) (3/5)
...
**Category:** [OPEN] Open · **Priority:** Medium · **Effort:** M · **Adoption Impact:** (ooo) (3/5)
...
**Category:** [OPEN] Open · **Priority:** Low · **Effort:** S · **Adoption Impact:** (oo) (2/5)
...
**Category:** [OPEN] Open · **Priority:** Low · **Effort:** L · **Adoption Impact:** (ooo) (3/5)
...
| v1.6.0 | 3 (G-07[OK], G-15[OK], G-21[OK]) | Stabilisation + dual licensing |
...
|---|:---:|:---:|:---:|
| First-run UX (--version, --expires 30d) | [FAIL] | [OK] | +5 |
| CI/CD integration (exit codes, Grype adapter) | [FAIL] | [OK] | +5 |
| Compliance mapping (ISO 27001, SOC2, NIS2, DORA) | [WARN] | [OK] | +4 |
| Formal risk acceptance (HMAC, audit trail) | [OK] | [OK] | = |
| SIEM verification (real TCP/HTTP probe) | [FAIL] | [OK] | +5 |
| RBAC (per-team profiles with identity check) | [FAIL] | [WARN] | +3 |
| Commercial embedding (legal framework) | [FAIL] | [WARN] | +4 |
| External security audit | [FAIL] | [FAIL] | = |
| Trademark protection | [FAIL] | [FAIL] | = |
| Test coverage enforcement | [FAIL] | [FAIL] | = |
