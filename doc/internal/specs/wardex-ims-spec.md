...
|---|---|---|---|
| `Control ID` | `Ref`, `Clause`, `ID`, `Control Ref` | string | [OK] |
| `Control Name` | `Name`, `Control`, `Title` | string | [OK] |
| `Applicable` | `Applicability`, `Include`, `In Scope` | bool* | [OK] |
| `Justification` | `Justification for Inclusion/Exclusion`, `Reason` | string | [OK] |
| `Implementation Status` | `Status`, `Implementation`, `Impl. Status` | enum** | [OK] |
...
Column mapping:
  [OK] Control ID        → col A  (header: "Ref")
  [OK] Control Name      → col B  (header: "Control Name")
  [OK] Applicable        → col C  (header: "Applicable (Y/N)")
  [OK] Justification     → col D  (header: "Justification for Inclusion")
  [OK] Status            → col E  (header: "Implementation Status")
  [OK] Owner             → col F  (header: "Control Owner")
  [OK] Evidence Ref      → col H  (header: "Evidence Reference")
  [FAIL] Context Weight    → not found  (default: 1.0)
  [FAIL] Risk Reference    → not found  (default: "")
